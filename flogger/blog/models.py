...
tag_x_post = db.Table('tag_x_post', 
    db.Column('tag_id', db.Integer, db.ForeingKey('tag.id'), primary_key=True),
...
class Post(db.Model):
    ...
    tags = db.relationship('Tag', secondary=tag_x_post, lazy='subquery', backref=db.backref('posts', lazy='dynamic'))
